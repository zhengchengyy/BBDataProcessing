...
if __name__ == '__main__':
    ...
    action_classify = {"turn_over":1, "legs_stretch":0, "hands_stretch":0,
                      "legs_twitch":2, "hands_twitch":2, "head_move":0, "grasp":2, "kick":2}
    for i in range(len(action_names)):
        ...
        draw_features_from_db(action=action_names[i],
                              ...
                              action_num=action_classify[action_names[i]])
