...
if __name__ == '__main__':
    ...
    action_abnormal = {"turn_over":0, "legs_stretch":0, "hands_stretch":0,
                      "legs_twitch":1, "hands_twitch":1, "head_move":0, "grasp":1, "kick":1}
    for i in range(len(action_names)):
        ...
        draw_features_from_db(action=action_names[i],
                              ...
                              action_num=action_abnormal[action_names[i]])
